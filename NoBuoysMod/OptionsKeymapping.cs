...
namespace NoBuoysMod
{
    public class OptionsKeymapping : UICustomControl
    {
        ...
        public static readonly SavedInputKey toggleBuoys = new SavedInputKey("toggleBuoys", NoBuoysMod.settingsFileName, SavedInputKey.Encode(KeyCode.Y, true, false, false), true);

        private int count = 0;

        private void Awake()
        {
            AddKeymapping(ModInfo.translation.GetTranslation( "NBM_TOGGLE_KEY" ), toggleBuoys);
        }
